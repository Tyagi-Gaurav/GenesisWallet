...
public final class CreateAccountServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.gw.user.grpc.CreateAccountService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.gw.user.grpc.AccountCreateGrpcRequestDTO,
      com.google.protobuf.Empty> getCreateAccountMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "createAccount",
      requestType = com.gw.user.grpc.AccountCreateGrpcRequestDTO.class,
      responseType = com.google.protobuf.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.gw.user.grpc.AccountCreateGrpcRequestDTO,
      com.google.protobuf.Empty> getCreateAccountMethod() {
    io.grpc.MethodDescriptor<com.gw.user.grpc.AccountCreateGrpcRequestDTO, com.google.protobuf.Empty> getCreateAccountMethod;
      ...
      synchronized (CreateAccountServiceGrpc.class) {
        if ((getCreateAccountMethod = CreateAccountServiceGrpc.getCreateAccountMethod) == null) {
          CreateAccountServiceGrpc.getCreateAccountMethod = getCreateAccountMethod =
              io.grpc.MethodDescriptor.<com.gw.user.grpc.AccountCreateGrpcRequestDTO, com.google.protobuf.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "createAccount"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.gw.user.grpc.AccountCreateGrpcRequestDTO.getDefaultInstance()))
  ...
  public static abstract class CreateAccountServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void createAccount(com.gw.user.grpc.AccountCreateGrpcRequestDTO request,
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.gw.user.grpc.AccountCreateGrpcRequestDTO,
  ...
  public static final class CreateAccountServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CreateAccountServiceBlockingStub> {
    ...
    /**
     */
    public com.google.protobuf.Empty createAccount(com.gw.user.grpc.AccountCreateGrpcRequestDTO request) {
  ...
  public static final class CreateAccountServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CreateAccountServiceFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty> createAccount(
        com.gw.user.grpc.AccountCreateGrpcRequestDTO request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_ACCOUNT:
          serviceImpl.createAccount((com.gw.user.grpc.AccountCreateGrpcRequestDTO) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        default:
