...
--changeset user:3
INSERT INTO USER_SCHEMA.USER_TABLE (ID, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD, SALT, DATE_OF_BIRTH, GENDER, HOME_COUNTRY, ROLE) values ('dcba7802-2eae-42b2-818e-a27f8f380088', 'admin@gw.com', 'Gaurav',
'Tyagi', '61646d696e313233', 'temporary-salt', '01/01/1980', 'MALE', 'GBR', 'ADMIN');
...
--changeset user:5
create TABLE IF NOT EXISTS USER_SCHEMA.EXTERNAL_USER_TABLE (
    ID VARCHAR(40) NOT NULL,
    EMAIL VARCHAR(40) UNIQUE NOT NULL,
    FIRST_NAME VARCHAR(256) NOT NULL,
    LAST_NAME VARCHAR(256) NOT NULL,
